...
export class ShopProfileComponent implements OnInit {
  ...
  setupProfileFieldsData(): void {
    this.profileFieldsData = [
      ...
      },
      {
        ...
        control: 'fssaiCertificateNumber',
        type: 'text',
        placeholder: 'e.g., 12345678901234'
      },
      {
        label: 'Grocery License Number',
        control: 'groceryLicenseNumber',
        type: 'text',
        placeholder: 'Enter grocery license number'
      },
      {
        label: 'Latitude',
        control: 'latitude',
  ...
  getFieldIcon(controlName: string): string {
    const iconMap: { [key: string]: string } = {
      ...
      gstNumber: 'receipt',
      panNumber: 'badge',
      fssaiCertificateNumber: 'verified_user',
      groceryLicenseNumber: 'description',
      ...
      next: (shop: any) => {
        if (shop) {
          ...
          this.shopForm.patchValue({
            ...
            fssaiCertificateNumber: shop.fssaiCertificateNumber || '',
            groceryLicenseNumber: shop.groceryLicenseNumber || '',
  ...
  onSave(): void {
    if (this.shopForm.valid && this.shop) {
      ...
      const updatedShop = {
        ...
        gstNumber: this.shopForm.value.gstNumber,
        panNumber: this.shopForm.value.panNumber,
        fssaiCertificateNumber: this.shopForm.value.fssaiCertificateNumber,
        groceryLicenseNumber: this.shopForm.value.groceryLicenseNumber,
      ...
      this.shopService.updateShop(this.shop.id, updatedShop).subscribe({
        next: (response) => {
          ...
          this.shopForm.patchValue({
            ...
            fssaiCertificateNumber: response.fssaiCertificateNumber || '',
            groceryLicenseNumber: response.groceryLicenseNumber || '',
