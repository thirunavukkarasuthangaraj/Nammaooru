...
@Component({
  selector: 'app-womens-corner-reported',
  templateUrl: './womens-corner-reported.component.html',
  styleUrls: ['./womens-corner-reported.component.scss']
})
export class WomensCornerReportedComponent implements OnInit {
  ...
  loadReportedPosts(): void {
    this.loading = true;
    this.womensCornerService.getReportedPosts(this.currentPage, this.pageSize).subscribe({
      next: (response) => {
