package com.shopmanagement.userservice.entity;
...
public class MobileOtp {
    ...
    public enum OtpPurpose {
        REGISTRATION, LOGIN, FORGOT_PASSWORD, CHANGE_MOBILE, VERIFY_MOBILE, ORDER_CONFIRMATION, ACCOUNT_VERIFICATION, PASSWORD_RESET
    }
