          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                TextField(controller: serviceNameController, decoration: InputDecoration(labelText: 'Service Name', border: const OutlineInputBorder(), suffixIcon: VoiceInputButton(controller: serviceNameController))),
                const SizedBox(height: 12),
                          ...
                          itemBuilder: (context, index) {
                            if (hasCarousel && index == 0) {
                              return _FeaturedBannerCarousel(
                                posts: carouselPosts,
                                onPostTap: (post) => Navigator.push(context, MaterialPageRoute(builder: (_) => ParcelPostDetailScreen(post: post))),
