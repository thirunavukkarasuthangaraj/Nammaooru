...
class FarmerPostDetailScreen extends StatefulWidget {
  final Map<String, dynamic> post;

  const FarmerPostDetailScreen({super.key, required this.post});

  @override
  State<FarmerPostDetailScreen> createState() => _FarmerPostDetailScreenState();
}

class _FarmerPostDetailScreenState extends State<FarmerPostDetailScreen> {
  ...
  void _openFullScreenGallery(int initialIndex) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => _FarmerFullScreenGallery(
            ...
            ElevatedButton(
              onPressed: selectedReason == null
                  ...
                  : () async {
                      ...
                      final farmerService = FarmerProductsService();
                      final result = await farmerService.reportPost(
                        post['id'],
                        selectedReason!,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          post['title'] ?? langProvider.getText('Product Details', 'பொருள் விவரங்கள்'),
              ...
              Row(
                ...
                children: List.generate(imageUrls.length, (index) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      color: _currentImageIndex == index ? _farmerGreen : Colors.grey[350],
...
class _FarmerFullScreenGallery extends StatefulWidget {
  final List<String> imageUrls;
  final int initialIndex;

  const _FarmerFullScreenGallery({required this.imageUrls, required this.initialIndex});

  @override
  State<_FarmerFullScreenGallery> createState() => _FarmerFullScreenGalleryState();
}

class _FarmerFullScreenGalleryState extends State<_FarmerFullScreenGallery> {
  late PageController _pageController;
