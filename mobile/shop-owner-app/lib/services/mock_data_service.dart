...
class MockDataService {
  ...
  // Mock shop data - Using ShopProfile model (Shop is an alias)
  static Shop get mockShop => ShopProfile.fromJson({
    'id': 'shop_001',
    ...
    'logo': 'https://example.com/shop-image.jpg',
    'images': [],
    'address': {
    ...
    'isVerified': true,
    'isActive': true,
    'registeredAt': DateTime.now().subtract(const Duration(days: 365)).toIso8601String(),
  ...
  static List<Product> get mockProducts => [
    Product(
      ...
      status: 'ACTIVE',
      image: 'https://example.com/rice1.jpg',
      sku: 'SKU001',
      unit: 'kg',
      stockQuantity: 25,
      minStockLevel: 5,
    ...
    Product(
      ...
      status: 'ACTIVE',
      image: 'https://example.com/cookies1.jpg',
      sku: 'SKU003',
      unit: 'pack',
      stockQuantity: 48,
      minStockLevel: 10,
    ...
    Product(
      ...
      status: 'OUT_OF_STOCK',
      image: 'https://example.com/maggi1.jpg',
      sku: 'SKU004',
      unit: 'pack',
      stockQuantity: 0,
      minStockLevel: 20,
    ...
    Product(
      ...
      status: 'ACTIVE',
      image: 'https://example.com/salt1.jpg',
      sku: 'SKU005',
      unit: 'kg',
      stockQuantity: 15,
      minStockLevel: 3,
  ...
  static List<NotificationModel> get mockNotifications => [
    NotificationModel(
      ...
      body: 'Order #001 from Rajesh Kumar for ₹412',
      type: 'new_order',
    ...
    NotificationModel(
      ...
      body: 'Payment of ₹112 received for Order #002',
    ...
    NotificationModel(
      ...
      body: 'Order #004 successfully delivered to Sneha Reddy',
    ...
    NotificationModel(
      ...
      body: 'Maggi 2-Minute Noodles is out of stock',
      type: 'low_stock',
    ...
    NotificationModel(
      ...
      body: 'Order #005 was cancelled due to out of stock',
